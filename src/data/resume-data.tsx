...
export const RESUME_DATA = {
  ...
  summary:
    "Working on a variety of projects, both large and small, with diverse teams has been a rewarding experience. I enjoy creating helpful products for the customer which enriches their lives. Driven by a continuous desire to learn and explore new areas, particularly in health and technology.",
